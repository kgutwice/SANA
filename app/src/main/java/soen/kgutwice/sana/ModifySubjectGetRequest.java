...
public class ModifySubjectGetRequest extends StringRequest {

    final static private String URL = "http://203.249.17.196:2013/ms/android/SANA_connector/getLecture.php";

    private Map<String, String> parameters;

    public ModifySubjectGetRequest(String userID, String subjectName, Response.Listener<String> listener){
